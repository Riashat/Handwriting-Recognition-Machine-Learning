function [correctlyClassified, mistakes, table,errorScannedDigits] = testNeuralNetwork(activationFunction, hiddenWeights, outputWeights,inputValues, labels, errorScannedDigits)
